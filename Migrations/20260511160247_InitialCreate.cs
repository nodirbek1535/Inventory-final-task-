        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessEntries_Inventories_InventoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FieldConfigurations_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedTextVsalue = table.Column<string>(type: "text", nullable: false),
                    FormatOptions = table.Column<string>(type: "text", nullable: false),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StringField1 = table.Column<string>(type: "text", nullable: false),
                    StringField2 = table.Column<string>(type: "text", nullable: false),
                    StringField3 = table.Column<string>(type: "text", nullable: false),
                    NumberField1 = table.Column<decimal>(type: "numeric", nullable: true),
                    NumberField2 = table.Column<decimal>(type: "numeric", nullable: true),
                    NumberField3 = table.Column<decimal>(type: "numeric", nullable: true),
                    BooleanField1 = table.Column<bool>(type: "boolean", nullable: true),
                    BooleanField2 = table.Column<bool>(type: "boolean", nullable: true),
                    BooleanField3 = table.Column<bool>(type: "boolean", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Version = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessEntries_InventoryId",
                table: "AccessEntries",
                column: "InventoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldConfigurations_InventoryId",
